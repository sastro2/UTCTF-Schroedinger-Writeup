...
<img src="Images/Challenge.PNG" alt="Challenge description" width="300"/>
...
<img src="Images/WebsiteHomescreen.png" alt="Website Homescreen" width="600"/>
...
<h3><a href="#windows">Windows section</a></h3> </br>
...
<img src="Images/etcPwdSymlink.PNG" alt="ln -s /etc/passwd" width="220"/> </br>
...
<img src="Images/zipPswd.PNG" alt="zip -y passwd.zip passwd" width="220"/> </br>
...
<img src="Images/etcPwdContent.PNG" alt="/etc/passwd contents" width="500"/> </br>

Among these users there is one that stands out in particular since it's not by default part of a linux machine, looks like we've found our username.</br>
So now let's move on to the flag itself.</br>

<img src="Images/symlinkToCopenhagen.PNG" alt="ln -s /home/copenhagen/flag.txt saveJosh" width="350"/> </br>
...
<img src="Images/zipSaveJosh.PNG" alt="zip -y saveJosh.zip saveJosh" width="250"/> </br>

And now when we upload it to the website...

<img src="Images/theFlag.PNG" alt="the flag!!" width="400"/> </br>

We get the flag! (and save Josh of course)</br></br></br></br>

<h1 id="windows">Continue here if you're using Windows</h1>